...
export default function CreateVenuePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-6 py-12">
      {/* Page header */}
      <div className="mb-8">
        <h1 className="mb-1 text-3xl font-bold text-gray-900">Create venue</h1>
        <p className="text-gray-500">Fill in the details for your new venue</p>
      </div>
          ...
          {[0, 1, 2, 3, 4, 5, 6, 7].map((index) => (
            <div key={index} className="flex items-center gap-3">
              ...
              <input
                ...
                className="flex-1 rounded-lg border border-gray-200 px-4 py-2.5 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900"
              />
            </div>
          ))}
        </div>
